...
func (d *Dao) UpdateReactions(ctx context.Context, filter *model.ReactionFilter, update map[string]any) (int64, error) {
...
func (d *Dao) CountReactions(ctx context.Context, f *model.ReactionFilter) (total int64, err error) {
	return db.Count(ctx, &model.Reaction{}, f)
}

func (d *Dao) FindReactions(ctx context.Context, f *model.ReactionFilter) (ms []*model.Reaction, err error) {
	err = db.Find(ctx, f, &ms)
	return
}

func (d *Dao) FindReaction(ctx context.Context, f *model.ReactionFilter) (*model.Reaction, error) {
...
func (d *Dao) FindReactionByID(ctx context.Context, id int64) (m *model.Reaction, err error) {
	return d.FindReaction(ctx, &model.ReactionFilter{ID: db.Eq(id)})
}

func (d *Dao) DeleteReactions(ctx context.Context, filter *model.ReactionFilter) error {
