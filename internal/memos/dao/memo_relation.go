...
func (d *Dao) UpdateMemoRelations(ctx context.Context, filter *model.MemoRelationFilter, update map[string]any) (int64, error) {
...
func (d *Dao) CountMemoRelations(ctx context.Context, f *model.MemoRelationFilter) (total int64, err error) {
	return db.Count(ctx, &model.MemoRelation{}, f)
}

func (d *Dao) FindMemoRelations(ctx context.Context, f *model.MemoRelationFilter) (ms []*model.MemoRelation, err error) {
	err = db.Find(ctx, f, &ms)
	return
}

func (d *Dao) FindMemoRelation(ctx context.Context, f *model.MemoRelationFilter) (*model.MemoRelation, error) {
...
func (d *Dao) DeleteMemoRelations(ctx context.Context, filter *model.MemoRelationFilter) error {
