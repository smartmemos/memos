...
const file_api_v1_auth_proto_rawDesc = "" +
	...
	".user.UserR\x04user2\xd2\x02\n" +
	"\vAuthService\x12V\n" +
	"\rGetAuthStatus\x12\x1c.api.v1.GetAuthStatusRequest\x1a\n" +
	".user.User\"\x1b\x82\xd3\xe4\x93\x02\x15\"\x13/api/v1/auth/status\x12H\n" +
	"\x06SignIn\x12\x15.api.v1.SignInRequest\x1a\n" +
	".user.User\"\x1b\x82\xd3\xe4\x93\x02\x15\"\x13/api/v1/auth/signin\x12H\n" +
	"\x06SignUp\x12\x15.api.v1.SignUpRequest\x1a\n" +
	".user.User\"\x1b\x82\xd3\xe4\x93\x02\x15\"\x13/api/v1/auth/signup\x12W\n" +
	"\aSignOut\x12\x16.api.v1.SignOutRequest\x1a\x16.google.protobuf.Empty\"\x1c\x82\xd3\xe4\x93\x02\x16\"\x14/api/v1/auth/signoutB3Z1github.com/smartmemos/memos/internal/proto/api/v1b\x06proto3"
