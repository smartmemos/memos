...
const (
	...
	MemoServiceName = "api.v1.MemoService"
)
...
const (
	...
	MemoServiceCreateMemoProcedure = "/api.v1.MemoService/CreateMemo"
	// MemoServiceListMemosProcedure is the fully-qualified name of the MemoService's ListMemos RPC.
	MemoServiceListMemosProcedure = "/api.v1.MemoService/ListMemos"
	// MemoServiceGetMemoProcedure is the fully-qualified name of the MemoService's GetMemo RPC.
	MemoServiceGetMemoProcedure = "/api.v1.MemoService/GetMemo"
	// MemoServiceUpdateMemoProcedure is the fully-qualified name of the MemoService's UpdateMemo RPC.
	MemoServiceUpdateMemoProcedure = "/api.v1.MemoService/UpdateMemo"
	// MemoServiceDeleteMemoProcedure is the fully-qualified name of the MemoService's DeleteMemo RPC.
	MemoServiceDeleteMemoProcedure = "/api.v1.MemoService/DeleteMemo"
)

// MemoServiceClient is a client for the api.v1.MemoService service.
type MemoServiceClient interface {
	// CreateMemo creates a memo.
	CreateMemo(context.Context, *connect.Request[CreateMemoRequest]) (*connect.Response[memo.Memo], error)
	// ListMemos lists memos with pagination and filter.
	ListMemos(context.Context, *connect.Request[ListMemosRequest]) (*connect.Response[ListMemosResponse], error)
	// GetMemo gets a memo.
	GetMemo(context.Context, *connect.Request[GetMemoRequest]) (*connect.Response[memo.Memo], error)
	// UpdateMemo updates a memo.
	UpdateMemo(context.Context, *connect.Request[UpdateMemoRequest]) (*connect.Response[memo.Memo], error)
	// DeleteMemo deletes a memo.
	DeleteMemo(context.Context, *connect.Request[DeleteMemoRequest]) (*connect.Response[emptypb.Empty], error)
}

// NewMemoServiceClient constructs a client for the api.v1.MemoService service. By default, it uses
...
func NewMemoServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MemoServiceClient {
	...
	memoServiceMethods := File_api_v1_memo_proto.Services().ByName("MemoService").Methods()
	return &memoServiceClient{
		createMemo: connect.NewClient[CreateMemoRequest, memo.Memo](
			httpClient,
		...
		getMemo: connect.NewClient[GetMemoRequest, memo.Memo](
			httpClient,
			baseURL+MemoServiceGetMemoProcedure,
			connect.WithSchema(memoServiceMethods.ByName("GetMemo")),
			connect.WithClientOptions(opts...),
		),
		updateMemo: connect.NewClient[UpdateMemoRequest, memo.Memo](
			httpClient,
...
type memoServiceClient struct {
	createMemo *connect.Client[CreateMemoRequest, memo.Memo]
	listMemos  *connect.Client[ListMemosRequest, ListMemosResponse]
	getMemo    *connect.Client[GetMemoRequest, memo.Memo]
	updateMemo *connect.Client[UpdateMemoRequest, memo.Memo]
	deleteMemo *connect.Client[DeleteMemoRequest, emptypb.Empty]
}

// CreateMemo calls api.v1.MemoService.CreateMemo.
func (c *memoServiceClient) CreateMemo(ctx context.Context, req *connect.Request[CreateMemoRequest]) (*connect.Response[memo.Memo], error) {
	return c.createMemo.CallUnary(ctx, req)
}

// ListMemos calls api.v1.MemoService.ListMemos.
...
// GetMemo calls api.v1.MemoService.GetMemo.
func (c *memoServiceClient) GetMemo(ctx context.Context, req *connect.Request[GetMemoRequest]) (*connect.Response[memo.Memo], error) {
	return c.getMemo.CallUnary(ctx, req)
}

// UpdateMemo calls api.v1.MemoService.UpdateMemo.
func (c *memoServiceClient) UpdateMemo(ctx context.Context, req *connect.Request[UpdateMemoRequest]) (*connect.Response[memo.Memo], error) {
	return c.updateMemo.CallUnary(ctx, req)
}

// DeleteMemo calls api.v1.MemoService.DeleteMemo.
...
// MemoServiceHandler is an implementation of the api.v1.MemoService service.
...
func NewMemoServiceHandler(svc MemoServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/api.v1.MemoService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedMemoServiceHandler) CreateMemo(context.Context, *connect.Request[CreateMemoRequest]) (*connect.Response[memo.Memo], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.MemoService.CreateMemo is not implemented"))
}
...
func (UnimplementedMemoServiceHandler) ListMemos(context.Context, *connect.Request[ListMemosRequest]) (*connect.Response[ListMemosResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.MemoService.ListMemos is not implemented"))
}

func (UnimplementedMemoServiceHandler) GetMemo(context.Context, *connect.Request[GetMemoRequest]) (*connect.Response[memo.Memo], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.MemoService.GetMemo is not implemented"))
}

func (UnimplementedMemoServiceHandler) UpdateMemo(context.Context, *connect.Request[UpdateMemoRequest]) (*connect.Response[memo.Memo], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.MemoService.UpdateMemo is not implemented"))
}
...
func (UnimplementedMemoServiceHandler) DeleteMemo(context.Context, *connect.Request[DeleteMemoRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.MemoService.DeleteMemo is not implemented"))
}
