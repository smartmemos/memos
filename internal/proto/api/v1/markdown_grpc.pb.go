...
const (
	MarkdownService_ParseMarkdown_FullMethodName          = "/api.v1.MarkdownService/ParseMarkdown"
	MarkdownService_RestoreMarkdownNodes_FullMethodName   = "/api.v1.MarkdownService/RestoreMarkdownNodes"
	MarkdownService_StringifyMarkdownNodes_FullMethodName = "/api.v1.MarkdownService/StringifyMarkdownNodes"
	MarkdownService_GetLinkMetadata_FullMethodName        = "/api.v1.MarkdownService/GetLinkMetadata"
)
...
type MarkdownServiceClient interface {
	...
	GetLinkMetadata(ctx context.Context, in *GetLinkMetadataRequest, opts ...grpc.CallOption) (*markdown.LinkMetadata, error)
}
...
func (c *markdownServiceClient) GetLinkMetadata(ctx context.Context, in *GetLinkMetadataRequest, opts ...grpc.CallOption) (*markdown.LinkMetadata, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(markdown.LinkMetadata)
...
type MarkdownServiceServer interface {
	...
	// GetLinkMetadata returns metadata for a given link.
	GetLinkMetadata(context.Context, *GetLinkMetadataRequest) (*markdown.LinkMetadata, error)
...
func (UnimplementedMarkdownServiceServer) GetLinkMetadata(context.Context, *GetLinkMetadataRequest) (*markdown.LinkMetadata, error) {
...
var MarkdownService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1.MarkdownService",
	...
	Metadata: "api/v1/markdown.proto",
}
