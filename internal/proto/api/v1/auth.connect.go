...
const (
	...
	// RPC.
	AuthServiceGetAuthStatusProcedure = "/api.v1.AuthService/GetAuthStatus"
	// AuthServiceSignInProcedure is the fully-qualified name of the AuthService's SignIn RPC.
	AuthServiceSignInProcedure = "/api.v1.AuthService/SignIn"
	...
	AuthServiceSignOutProcedure = "/api.v1.AuthService/SignOut"
)
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	authServiceMethods := File_api_v1_auth_proto.Services().ByName("AuthService").Methods()
...
// GetAuthStatus calls api.v1.AuthService.GetAuthStatus.
...
// SignIn calls api.v1.AuthService.SignIn.
...
// SignOut calls api.v1.AuthService.SignOut.
...
func (UnimplementedAuthServiceHandler) GetAuthStatus(context.Context, *connect.Request[GetAuthStatusRequest]) (*connect.Response[user.User], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.AuthService.GetAuthStatus is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) SignIn(context.Context, *connect.Request[SignInRequest]) (*connect.Response[user.User], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.AuthService.SignIn is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) SignOut(context.Context, *connect.Request[SignOutRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.AuthService.SignOut is not implemented"))
}
