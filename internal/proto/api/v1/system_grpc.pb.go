...
const (
	SystemService_CreateUser_FullMethodName = "/api.v1.SystemService/CreateUser"
)
...
type SystemServiceClient interface {
	...
	CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*system.User, error)
}
...
func (c *systemServiceClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*system.User, error) {
...
type SystemServiceServer interface {
	// CreateUser creates a new user.
	CreateUser(context.Context, *CreateUserRequest) (*system.User, error)
...
func (UnimplementedSystemServiceServer) CreateUser(context.Context, *CreateUserRequest) (*system.User, error) {
...
func _SystemService_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SystemServiceServer).CreateUser(ctx, req.(*CreateUserRequest))
	}
...
var SystemService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1.SystemService",
