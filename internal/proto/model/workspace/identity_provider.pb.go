...
const file_model_workspace_identity_provider_proto_rawDesc = "" +
	"\n" +
	"'model/workspace/identity_provider.proto\x12\tworkspace\x1a\x1fgoogle/protobuf/timestamp.proto\"\x84\x02\n" +
	"\x10IdentityProvider\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x124\n" +
	"\x04type\x18\x02 \x01(\x0e2 .workspace.IdentityProvider.TypeR\x04type\x12\x14\n" +
	"\x05title\x18\x03 \x01(\tR\x05title\x12+\n" +
	"\x11identifier_filter\x18\x04 \x01(\tR\x10identifierFilter\x129\n" +
	"\x06config\x18\x05 \x01(\v2!.workspace.IdentityProviderConfigR\x06config\"(\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06OAUTH2\x10\x01\"b\n" +
	"\x16IdentityProviderConfig\x12>\n" +
	"\roauth2_config\x18\x01 \x01(\v2\x17.workspace.OAuth2ConfigH\x00R\foauth2ConfigB\b\n" +
	"\x06config\"g\n" +
	...
	"\x05email\x18\x03 \x01(\tR\x05email\"\x82\x02\n" +
	...
	"\rfield_mapping\x18\a \x01(\v2\x17.workspace.FieldMappingR\ffieldMappingB<Z:github.com/smartmemos/memos/internal/proto/model/workspaceb\x06proto3"
